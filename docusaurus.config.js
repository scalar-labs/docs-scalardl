  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'new_version',
        content:
          '<b>🎊ScalarDL Ledger, the ledger database middleware component of ScalarDL, is now open-sourced under Apache License 2.0! To try it out, see <a target="_self" href="/docs/latest/getting-started">Get Started with ScalarDL Ledger</a>.</b>',
