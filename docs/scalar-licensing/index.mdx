...
If you're using a trial license, ScalarDL must be connected to the Internet. An Internet connection is required to check if the trial license is valid and hasn't expired.
