...
The Java Client SDK APIs are provided by a service class called <JavadocLink packageName="scalardl-java-client-sdk" path="com/scalar/dl/client/service" className="ClientService" />. The following is a code snippet that shows how to use `ClientService` to execute a contract.
...
For more details, see <JavadocLink packageName="scalardl-java-client-sdk" path="com/scalar/dl/ledger/service" className="StatusCode" />.
...
You can get <JavadocLink packageName="scalardl-java-client-sdk" path="com/scalar/dl/ledger/proof" className="AssetProof" /> from the result <JavadocLink packageName="scalardl-java-client-sdk" path="com/scalar/dl/ledger/model" className="ContractExecutionResult" /> of the `executeContract` method of the Client SDK. An Asset Proof can be validated if it is not tampered and it is from Ledger by verifying the signature.
