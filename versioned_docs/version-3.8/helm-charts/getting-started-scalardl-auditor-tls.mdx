...
1. Set your license key and certificate as environment variables. If you don't have a license key, please [contact us](https://www.scalar-labs.com/contact). Also, you can see the value of `<CERT_PEM_FOR_YOUR_SCALAR_DL_LEDGER_LICENSE_KEY>` and `<CERT_PEM_FOR_YOUR_SCALAR_DL_AUDITOR_LICENSE_KEY>` in [our document](https://scalardb.scalar-labs.com/docs/latest/scalar-licensing/README/).
