...
ScalarDB Server is now deprecated. Please use [ScalarDB Cluster](how-to-deploy-scalardb-cluster.mdx) instead.
...
* [[Deprecated] Configure a custom values file for ScalarDB Server](configure-custom-values-scalardb.mdx)
