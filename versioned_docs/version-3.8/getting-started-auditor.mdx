...
* [What an Asset Proof is and how to access it](how-to-write-applications.mdx#what-is-asset-proof)
...
Note that you also need to enable `scalar.dl.ledger.proof.enabled` and set a proper private key to `scalar.dl.ledger.proof.private_key_path` since Auditor uses [AssetProof](how-to-write-applications.mdx#what-is-asset-proof) to work.
...
See [scalardl-samples](https://github.com/scalar-labs/scalardl-samples) repo for more details about how to use the containers.
