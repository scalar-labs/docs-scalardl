...
- Upgraded ScalarDB to 3.17.5, which replaces MySQL Connector/J with MariaDB Connector/J. ([#526](https://github.com/scalar-labs/scalardl/pull/526))
...
- Fixed [CVE-2026-54512](https://github.com/advisories/GHSA-j3rv-43j4-c7qm "CVE-2026-54512") and [CVE-2026-54513](https://github.com/advisories/GHSA-rmj7-2vxq-3g9f "CVE-2026-54513"). ([#590](https://github.com/scalar-labs/scalardl/pull/590))
