...
To run Scalar products, you must create a `.properties` file and add your commercial license key and a certificate to the file. In your `.properties` file, copy one of the following configurations, based on the product you're using, and paste the contents in the `.properties` file, replacing `<YOUR_LICENSE_KEY>` with your license key.

:::note

- If you don't have a license key, please see [Trial License Keys](./trial.mdx) for ready-to-use keys or [contact us](https://www.scalar-labs.com/contact) to obtain a commercial license.
