...
You must set `auditor.auditorProperties`. Please set your `auditor.properties` to this parameter. For more details, see the [ScalarDL Auditor configurations](../configurations.mdx#auditor-configurations).
