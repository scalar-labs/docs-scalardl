...
You must set `ledger.ledgerProperties`. Please set your `ledger.properties` to this parameter. Set the configurations according to your environment. For more details, see the [ScalarDL Ledger configurations](../configurations.mdx#ledger-configurations).
