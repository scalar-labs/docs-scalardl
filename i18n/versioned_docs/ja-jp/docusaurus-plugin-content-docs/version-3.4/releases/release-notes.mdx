...
このページには、ScalarDL 3.4 のリリースノートのリストが含まれています。
...
- 内部 JRE Docker ベースイメージを 1.1.2 に更新しました。
...
- 入力データの保存を設定可能にしました。
- コメントの追加、範囲の修正、軽微な問題の修正により、設定関連の側面が改善されました。
