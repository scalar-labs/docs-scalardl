...
<Tabs groupId="products" queryString>
  ...
  <TabItem value="scalardb-server" label="ScalarDB Server (非推奨)">
    <h3>ScalarDB Server 3.8 以降 (Apache Commons Text 構文)</h3>
    ...
    <h3>ScalarDB Server 3.7 以前 (Go テンプレート構文)</h3>
  ...
  <TabItem value="scalardl-ledger" label="ScalarDL Ledger">
    <h3>ScalarDL Ledger 3.8 以降 (Apache Commons Text 構文)</h3>
    ...
    <h3>ScalarDL Ledger 3.7 以前 (Go テンプレート構文)</h3>
  ...
  <TabItem value="scalardl-auditor" label="ScalarDL Auditor">
    <h3>ScalarDL Auditor 3.8 以降 (Apache Commons Text 構文)</h3>
    ...
    <h3>ScalarDL Auditor 3.7 以前 (Go テンプレート構文)</h3>
  ...
  <TabItem value="scalardl-schema-loader" label="ScalarDL Schema Loader">
    <h3>ScalarDL Schema Loader 3.8 以降 (Apache Commons Text 構文)</h3>
    ...
    <h3>ScalarDL Schema Loader 3.7 以前 (Go テンプレート構文)</h3>
