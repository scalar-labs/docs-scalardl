...
ScalarDLにはいくつかの種類の認証方式があります。 認証方法として `digital-signature` を使用する場合は、秘密鍵と証明書ファイルを準備する必要があります。 認証方法の詳細については、[ScalarDL 認証ガイド](https://github.com/scalar-labs/docs-internal-scalardl/blob/main/docs/ja-jp/authentication.mdx)を参照してください。
