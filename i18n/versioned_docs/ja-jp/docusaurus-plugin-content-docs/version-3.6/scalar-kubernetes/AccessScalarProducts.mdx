...
カスタム値ファイルの設定方法の詳細については、[サービス設定](https://github.com/scalar-labs/helm-charts/blob/main/docs/configure-custom-values-envoy.mdx#service-configurations)を参照してください。
