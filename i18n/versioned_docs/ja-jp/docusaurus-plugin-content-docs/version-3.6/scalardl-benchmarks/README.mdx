...
- [Ledger のみの構成](https://github.com/scalar-labs/scalardl/blob/master/docs/getting-started.mdx)
- [Ledger と Auditor の構成](https://github.com/scalar-labs/scalardl/blob/master/docs/getting-started-auditor.mdx)
